...
Kenali Drs. Chaeroni & Rekan — Kantor Akuntan Publik terdaftar di Kementerian Keuangan RI dengan 75+ tenaga profesional di Jakarta, Bekasi, dan Semarang.
@endsection
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="reveal relative">
          <div class="rounded-3xl bg-gradient-to-br from-brand-900 to-brand-950 p-8 sm:p-12">
            ...
            <div class="mt-8 flex items-center gap-4">
              <span class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-700 to-slate-900 flex items-center justify-center font-heading font-bold text-white">DC</span>
              <div>
  ...
  <section class="py-24 bg-slate-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-2xl reveal">
        ...
        <p class="mt-4 text-slate-600">75+ tenaga profesional — termasuk 14 auditor senior dengan pengalaman lebih dari 5 tahun — di tiga kantor, yang terus memperbarui kompetensinya di tengah perubahan regulasi.</p>
      </div>
      ...
      <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse ($teamMembers as $index => $member)
          ...
          <div class="reveal group bg-slate-50 border border-slate-100 rounded-3xl p-8 card-hover text-center">
            <span class="mx-auto w-28 h-28 rounded-3xl bg-gradient-to-br from-blue-700 to-slate-900 flex items-center justify-center font-heading text-4xl font-bold text-white">{{ $initials }}</span>
        ...
        @empty
          ...
          @foreach ($fallbackMembers as $member)
            ...
            @endphp
            <div class="reveal group bg-slate-50 border border-slate-100 rounded-3xl p-8 card-hover text-center">
              <span class="mx-auto w-28 h-28 rounded-3xl bg-gradient-to-br from-blue-700 to-slate-900 flex items-center justify-center font-heading text-4xl font-bold text-white">{{ $member['initials'] }}</span>
              <h3 class="mt-6 font-heading text-xl font-bold text-slate-900">{{ $member['name'] }}</h3>
              <p class="text-sm text-slate-500 mt-1">{{ $member['position'] }}</p>
              <p class="mt-4 text-sm text-slate-600 leading-relaxed">{{ $bioShort }}</p>
              @if ($bioTruncated)
    ...
    <div class="relative h-full flex items-end sm:items-center justify-center p-0 sm:p-4">
      <div class="relative bg-white w-full sm:max-w-md sm:rounded-3xl rounded-t-3xl shadow-2xl max-h-[85vh] flex flex-col">
        ...
        <div class="p-8 pt-10 overflow-y-auto">
          <span id="team-bio-avatar" class="mx-auto w-20 h-20 rounded-3xl bg-gradient-to-br from-blue-700 to-slate-900 flex items-center justify-center font-heading text-2xl font-bold text-white"></span>
